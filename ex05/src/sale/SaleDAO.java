...
public class SaleDAO {
	...
	public void delete(int code) {
		try {
			...
			System.out.println("매출 삭제 : " + e.toString());
		}
	}
		...
		try {
			...
			while((line = reader.readLine()) != null) {
				...
				if(code == Integer.parseInt(items[0])) {
					...
					sale.setCnt(Integer.parseInt(items[3]));
				}
			}
		} catch (Exception e) {
			// TODO Auto-generated catch block
	...
	public void insert(Sale sale) {
		try {
			...
			writer.write(String.format("%d,%s,%d,%d\n", sale.getCode(), sale.getName(), sale.getPrice(), sale.getCnt()));
			writer.close();
		} catch (Exception e) {
			// TODO Auto-generated catch block
	...
	public ArrayList<Sale> list() {
		...
		try {
			...
			// TODO Auto-generated catch block
			System.out.println("매출목록 오류 : " + e.toString());
		}
		return array;
	}
}
